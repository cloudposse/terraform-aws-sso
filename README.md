...
This is `terraform-aws-sso` project provides all the scaffolding for a typical well-built Cloud Posse module. It's a template repository you can
...
- [`examples/complete`](https://github.com/cloudposse/terraform-aws-sso/) - complete example of using this module
